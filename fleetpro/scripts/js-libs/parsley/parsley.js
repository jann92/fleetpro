...
(function (global, factory) {
  ...
  var typeRegexes = {
      email: /^((([a-z]|\d|[!#\$%&'\\-\/=\?\^_`{\|}~]|[\u0{2}A0-uD7F{2}\uF90{2}-\uFDCF\uFDF0-\uF{2}EF])+(\.([a-z]|\d|[!#\$%&'\\-\/=\?\^_`{\|}~]|[\u0{2}A0-uD7F{2}\uF90{2}-\uFDCF\uFDF0-\uF{2}EF])+)|(\x(2{2})((((\x20|09)*(\x0d\x0a))?\x(20|09)+)?(([\x01-x08\x0b\x0c\x0e-\x1f\x7f]|\x21|[\x23-x5b]|[\x5d-x7e]|[\u0{2}A0-uD7F{2}\uF90{2}-\uFDCF\uFDF0-\uF{2}EF])|(\\[\(x01-\x09\x0b\x0c\x0d-\x7f]|u0{2}A0-\uD7F{2}\uF90{2}-\uFDCF\uFDF0-\uF{2}EF]))))*((\x(20|09)*(\x0d\x0a))?\x(20|09)+)?(\x2{2})))@((([a-z]|\d|[\u0{2}A0-uD7F{2}\uF90{2}-\uFDCF\uFDF0-\uF{2}EF])|(([a-z]|\d|[\u0{2}A0-uD7F{2}\uF90{2}-\uFDCF\uFDF0-\uF{2}EF])([a-z]|\d|-|\.|_|~|[\u0{2}A0-uD7F{2}\uF90{2}-\uFDCF\uFDF0-\uF{2}EF])*([a-z]|\d|[\u0{2}A0-uD7F{2}\uF90{2}-\uFDCF\uFDF0-\uF{2}EF])))\.)+([(a-z]|\u0{2}A0-\uD7F{2}\uF90{2}-\uFDCF\uFDF0-\uF{2}EF])|([(a-z]|\u0{2}A0-\uD7F{2}\uF90{2}-\uFDCF\uFDF0-\uF{2}EF])([a-z]|\d|-|\.|_|~|[\u0{2}A0-uD7F{2}\uF90{2}-\uFDCF\uFDF0-\uF{2}EF])*[(a-z]|\u0{2}A0-\uD7F{2}\uF90{2}-\uFDCF\uFDF0-\uF{2}EF])))$/i,
